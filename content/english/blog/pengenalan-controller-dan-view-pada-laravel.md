...
tags: ["modul", "praktikum", "pemrograman", "framework", "laravel", "controller", "view"]
draft: false
---
...
{{< notice "note" >}}
  ...
  {{< button label="Modul 03: Routing dan Bundling Asset di Laravel" link="/blog/routing-dan-bundling-asset-di-laravel" style="outline" class="btn-sm w-full" >}}
