...
![Bootstrap Clone](/images/blog/bs-clone.png)
...
- Praktekkan kode HTML di bawah ini pada file **index.html** yang telah dibuat. Letakkan di dalam block tag `<body>`.
  ...
  ![Navbar Bootstrap Clone](/images/blog/navbar-bs-clone-1.png)

  ![Navbar Bootstrap Clone](/images/blog/navbar-bs-clone-2.png)

  ![Navbar Bootstrap Clone](/images/blog/navbar-bs-clone-3.png)
...
- Praktekkan kode HTML di bawah ini pada file **index.html** yang telah dibuat. Letakkan di dalam block tag `<body>`.
  ...
  ![Main Bootstrap Clone](/images/blog/main-bs-clone.png)
...
- Praktekkan kode HTML di bawah ini pada file **index.html** yang telah dibuat. Letakkan di dalam block tag `<body>`.
  ...
  ![Icons Bootstrap Clone](/images/blog/icons-bs-clone.png)
...
- Praktekkan kode HTML di bawah ini pada file **index.html** yang telah dibuat. Letakkan di dalam block tag `<body>`.
  ...
  ![Themes Bootstrap Clone](/images/blog/themes-bs-clone.png)
...
- Praktekkan kode HTML di bawah ini pada file **index.html** yang telah dibuat. Letakkan di dalam block tag `<body>`.
  ...
  ![Footer Bootstrap Clone](/images/blog/footer-bs-clone.png)
